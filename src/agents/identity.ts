import type { AgentShieldConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityName(cfg: AgentShieldConfig, agentId: string): string | undefined {
