...
function resolveExecConfig(params: { cfg?: AgentShieldConfig; agentId?: string }) {
...
function resolveFsConfig(params: { cfg?: AgentShieldConfig; agentId?: string }) {
  const cfg = params.cfg;
