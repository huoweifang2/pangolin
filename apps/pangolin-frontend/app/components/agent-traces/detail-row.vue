              ...
              <div class="pa-2">
                ...
                <div v-if="iter.llm_call" class="iter-subsection mb-4">
                  ...
                  <div class="d-flex flex-wrap ga-3">
                    <v-chip v-if="iter.llm_call.tokens_in != null" size="x-small" variant="tonal" color="info">
                      <v-icon start size="12">mdi-arrow-down</v-icon>
                      {{ iter.llm_call.tokens_in }} in
                    </v-chip>
                    <v-chip v-if="iter.llm_call.tokens_out != null" size="x-small" variant="tonal" color="info">
