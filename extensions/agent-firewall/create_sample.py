...
DB_PATH = "/Users/yingwu/main/projects/agent-firewall/extensions/agent-firewall/data/firewall.db"
...
async def create_sample_dataset():
    ...
    try:
        async with aiosqlite.connect(DB_PATH) as db:
            ...
            async with db.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='datasets'") as cursor:
            ...
            dataset = {
                ...
                "is_public": False,
                "metadata": json.dumps({"description": "This is a test dataset created programmatically."}),
                "created_at": now,
                "updated_at": now
            }
